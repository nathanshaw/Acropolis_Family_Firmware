...
//////////////////////////////// Global Objects /////////////////////////
WS2812Serial leds(LED1_COUNT, LED_DISPLAY_MEMORY, LED_DRAWING_MEMORY, LED_PIN, WS2812_GRB);

NeoGroup neos = NeoGroup(&leds, 0, LED1_COUNT - 1, "All Neos", MIN_FLASH_TIME, MAX_FLASH_TIME);
...
#if HV_MAJOR > 2
WeatherManager weather_manager = WeatherManager(HUMID_EXTREME_THRESH, TEMP_EXTREME_THRESH, TEMP_HISTERESIS);
#endif // HV_MAJOR
...
AudioAnalyzeFFT1024      fft;      //xy=521.3627586364746,251.71987438201904
...
AudioConnection          patchCord8(amp1, fft);
